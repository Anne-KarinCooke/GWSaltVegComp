...
//           // double beta = Svir_sub(i,j,tt)/M_sub(i,j,tt);
//           // b2 = b2 * beta;
//           // b1 = 1.0 - b2;
//           
  ...
  //     Balance of salt mass in overland flow depth h
        ...
        //  Smh_sub(i,j,tt) = Smh_sub(i,j,tt) + (ConcConst_in * Rain_in) + (CM_sub(i,j,tt) * seep_sub(i,j,tt)) (q_sub(i,j,tt)*Ch_sub(i,j,tt)) +  salt_runon_sub(i,j,tt);
...
// }
// 
// List output = Rcpp::List::create(Rcpp::Named("I_sub") = I_sub,
//                                  Rcpp::Named("M_sub") = M_sub,
//                                  Rcpp::Named("h_sub") = h_sub,
//                                  Rcpp::Named("Gr_sub") = Gr_sub,
//                                  Rcpp::Named("Svir_sub") = Svir_sub,
//                                  Rcpp::Named("Mo_sub") = Mo_sub,
//                                  Rcpp::Named("WU_sub") = WU_sub,
//                                  Rcpp::Named("P_sub") = P_sub);
//                                  
//                                  
//                                  return output;
//                                  }
...
# library(rasterVis)
# qr<-brick(results$fields[[6]][2:9,2:9,1:20])
